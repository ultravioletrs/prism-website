        ...
        <section className="py-20 bg-muted/30">
            <div className="container px-4 md:px-6">
                <div className="max-w-4xl mx-auto text-center p-12 rounded-2xl border border-brand-secondary/30 bg-gradient-to-br from-brand-secondary/5 to-primary/5">
                    <h2 className="text-3xl md:text-4xl font-bold tracking-tight mb-4">Ready to Collaborate on Healthcare AI?</h2>
                    <p className="text-muted-foreground text-lg leading-relaxed mb-8 max-w-2xl mx-auto">Train models across institutions without moving patient data. Collaborate with hospitals, pharma, and research partners while maintaining HIPAA compliance and data custody.</p>
