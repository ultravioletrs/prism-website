        ...
        <div className="container mx-auto py-16 px-4 md:px-6 max-w-4xl">
            ...
            <div className="space-y-8 text-foreground/90">
                    ...
                    <div className="space-y-4 ml-4">
                        <div>
                            ...
                            <ul className="list-disc pl-5 space-y-1">
                                ...
                                <li>Provide access to the Prism AI platform</li>
                                <li>Process and deliver AI/ML services</li>
                ...
                <section>
                    ...
                    <p className="mt-4">
                        <strong>Cookie Management:</strong> You can manage your cookie preferences through your browser settings or our cookie consent banner.
                    </p>
                </section>
                ...
                <section>
                    ...
                    <div className="space-y-4 ml-4">
                        ...
                        <div>
                            <h3 className="text-lg font-semibold mb-2">6.3 Data Processing Agreements</h3>
                            <p>
                ...
                <section>
                    ...
                    <ul className="list-disc pl-5 space-y-1">
                        ...
                        <li><strong>Closed accounts:</strong> Data retained for up to [X] years after account closure for legal and operational obligations</li>
                        <li><strong>Financial records:</strong> Retained for statutory periods required by tax and accounting laws</li>
                        <li><strong>Analytics data:</strong> May be anonymized and retained indefinitely for statistical purposes</li>
                        <li><strong>Legal claims:</strong> Data retained as necessary to establish, exercise, or defend legal claims</li>
                    </ul>
                </section>
                ...
                <section>
                    ...
                    <div className="space-y-4 ml-4">
                        <div>
                            <h3 className="text-lg font-semibold mb-2">9.1 Right of Access (Article 15)</h3>
                            <p>Request confirmation of whether we process your data and obtain a copy of your personal data.</p>
                        </div>

                        <div>
                            <h3 className="text-lg font-semibold mb-2">9.2 Right to Rectification (Article 16)</h3>
                            <p>Correct inaccurate or incomplete personal data without undue delay.</p>
                        </div>
                        ...
                        <div>
                            <h3 className="text-lg font-semibold mb-2">9.4 Right to Restriction of Processing (Article 18)</h3>
                            <p>Request limitation of processing in certain circumstances (e.g., while verifying accuracy).</p>
                        </div>

                        <div>
                            <h3 className="text-lg font-semibold mb-2">9.5 Right to Data Portability (Article 20)</h3>
                            <p>Receive your data in a structured, commonly used format and transmit it to another controller.</p>
                        </div>

                        <div>
                            <h3 className="text-lg font-semibold mb-2">9.6 Right to Object (Article 21)</h3>
                            <p>Object to processing based on legitimate interests or for direct marketing purposes.</p>
                        </div>

                        <div>
                            <h3 className="text-lg font-semibold mb-2">9.7 Right to Withdraw Consent</h3>
                            <p>Withdraw consent at any time where processing is based on consent.</p>
                        </div>

                        <div>
                            <h3 className="text-lg font-semibold mb-2">9.8 Right to Lodge a Complaint (Article 77)</h3>
                            <p>Lodge a complaint with your local data protection authority if you believe your rights have been violated.</p>
                        </div>
                    </div>
