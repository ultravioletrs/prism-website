...
![Roles Page](/img/ui/roles_page.png)
...
![Admin Role](/img/ui/admin_workspace_roles.png)
...
4. Add specific permissions as needed:
   ...
   ![Add New Role](/img/ui/workspace_roles.png)
...
![Add New Role](/img/ui/custom_role_added.png)
...
![Open Invitations](/img/ui/navigate_to_invitations.png)
...
![Empty Invitations](/img/ui/empty_invitations_page.png)
2. Click **Invite User**
![Invite User](/img/ui/invite_user_button.png)
3. Enter the user's details:

   - Username
   - Assigned role (e.g., Admin, Member, Viewer)

![Select user](/img/ui/select_user_to_invite.png)
4. Click **Send Invitation**. The invitation will appear in your Invitations table with a **Pending** status.
![Pending Invitations](/img/ui/pending_invited_user.png)
...
![Accepted Invitations](/img/ui/accepted_invitations.png)
...
![Pending Invitations](/img/ui/view_invitation.png)
...
![Invitations Request](/img/ui/invited_user_receives_request.png)
...
![Invitations Request](/img/ui/invited_user_workspace_visible.png)
...
![Rejected Invitations](/img/ui/rejected_invitations.png)
...
![Resend Invitation](/img/ui/resend_invitation.png)

It will open a modal to reinvite the user:

![Reinvite User](/img/ui/reinvite_user.png)
...
![Delete Invitation](/img/ui/delete_invitation.png)

3. Confirm the deletion in the popup

![Invitation Deleted](/img/ui/invitation_deleted_popup.png)
