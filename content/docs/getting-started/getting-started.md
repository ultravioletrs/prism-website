...
![Registration Process](/img/ui/login.png)
...
![Login Page](/img/ui/login_page.png)
...
![Workspace Creation](/img/ui/projcreate.png)
![Workspace Setup](/img/ui/newproj.png)
...
![Workspace Login](/img/ui/wkslogin.png)
...
![Generated keys](/img/getting_started_keys.png)
...
![CVM Creating](/img/ui/cvm_creating.png)
![CVM Online](/img/cvms/online-cvm.png)
...
![Upload public key](/img/ui/upload_public_key.png)
- This opens a box for you to select a public key
 ![Upload public key success](/img/ui/upload_key.png)
- From the [generated keys here](#generate-your-keys), upload your public key and indicator will disappear as below:
 ![Upload public key success](/img/ui/upload_public_key_success.png)
...
![Generate Hashes](/img/generate_hashes.png)
...
3. Fill in:
   ...
   - **File Hash**: Paste the hash from `lin_reg.py`
      ...
      ![New Asset](/img/ui/new_asset.png)
...
1. From your **Assets** page, find "Iris Classification Model"
   ...
   ![Algo Assets](/img/ui/algo_assets.png)

2. Click **Associate**

   ![Associate Algo](/img/ui/algo_associate.png)

3. Select your computation (e.g., "Iris Classification Demo")
4. Confirm

   ![Associate Asset](/img/ui/associate_algo_asset.png)
...
3. Fill in:
   ...
   - **File Hash**: Paste the hash from `iris.csv`
      ...
      ![New Asset](/img/ui/create_dataset.png)

4. Click **Create Asset**
5. Click **Associate**

   ![Associate Algo](/img/ui/dataset_associate.png)

6. Select your computation (e.g., "Iris Classification Demo")
7. Confirm

   ![Associate Asset](/img/ui/associate_dataset_asset.png)
There will be a tag that shows the associated computation for each linked asset:

   ![Associate Asset Success](/img/ui/associate_user_asset_success.png)
...
![Run Disabled](/img/ui/run_computation_disabled.png)
...
3. Confirm execution
   ![Confirm Execution](/img/ui/successfully_running_computation.png)
...
![Agent URL](/img/ui/agent_url.png)
...
![Dataset Uploaded CLI](/img/upload_dataset_cli.png)
...
![Dataset Uploaded CLI](/img/ui/computation_logs.png)
...
**Example output:**
![Stop Computation](/img/computation_Results.png)
...
![Stop Computation](/img/ui/stop_computation.png)
![Stop Computation Run](/img/ui/stop_computation_run.png)
